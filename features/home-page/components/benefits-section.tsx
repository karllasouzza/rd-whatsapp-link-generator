        ...
        <section className="flex w-full flex-col gap-6">
          <article className="flex flex-col justify-start gap-2">
            <span className="body-sm md:body-md text-left text-foreground">
              ...
              são mais de 165 milhões de usuários* (ou 96,4% da população que
              faz uso das redes sociais). Quando você traz um link de WhatsApp
              nas redes sociais ou site da sua empresa, só tem vantagens:
            </span>
